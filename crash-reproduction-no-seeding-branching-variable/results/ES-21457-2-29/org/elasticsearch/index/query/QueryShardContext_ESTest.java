...
public class QueryShardContext_ESTest extends QueryShardContext_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(true).when(indexSettings0).isDefaultAllowUnmappedFields();
      ...
      LeafReader[] leafReaderArray0 = new LeafReader[0];
      ParallelLeafReader parallelLeafReader0 = new ParallelLeafReader(true, leafReaderArray0, leafReaderArray0);
      ...
      QueryShardContext queryShardContext0 = new QueryShardContext(indexSettings0, (BitsetFilterCache) null, indexFieldDataService0, mapperService0, similarityService0, scriptService0, indicesQueriesRegistry0, client0, parallelLeafReader0, clusterState0, longSupplier0);
