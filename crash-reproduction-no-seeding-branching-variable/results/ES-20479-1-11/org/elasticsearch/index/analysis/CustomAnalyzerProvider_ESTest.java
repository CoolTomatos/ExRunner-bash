...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(".(td@\"-rX{").when(index0).name();
      ...
      Index index1 = new Index("Invalid vLong detected (more than 64 bits)");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      UAX29URLEmailTokenizerFactory uAX29URLEmailTokenizerFactory0 = new UAX29URLEmailTokenizerFactory(index1, indexSettingsService1, "Invalid vLong detected (more than 64 bits)", settings0);
