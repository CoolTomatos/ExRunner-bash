...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("cannot handle analyzed forms > 32765 in length (got ").when(index0).name();
      ...
      stringArray0[0] = "cannot handle analyzed forms > 32765 in length (got ";
      stringArray0[1] = "";
      ...
      Settings settings2 = IndexMetaData.addHumanReadableSettings(settings0);
      customAnalyzerProvider0.get();
      EdgeNGramTokenizerFactory edgeNGramTokenizerFactory0 = new EdgeNGramTokenizerFactory(index1, settings2, (String) null, settings2);
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, "4Go*03.$!Nv;bw", settings0);
