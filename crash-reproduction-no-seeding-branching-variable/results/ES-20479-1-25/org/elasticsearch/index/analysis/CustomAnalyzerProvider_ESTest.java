...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "] defined both [position_offset_gap] and [position_increment_gap], use only [position_increment_gap]", settings1);
      Index index1 = new Index("?E+IpV;XVU<*%");
