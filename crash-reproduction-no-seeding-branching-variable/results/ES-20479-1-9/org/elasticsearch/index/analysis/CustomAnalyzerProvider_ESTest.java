...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "-p3+1>_h?7XD~nTur", settings1);
      Index index1 = new Index("tokenizer");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      EdgeNGramTokenizerFactory edgeNGramTokenizerFactory0 = new EdgeNGramTokenizerFactory(index1, indexSettingsService1, "tokenizer", settings0);
