...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      stringArray0[0] = "position_offset_gap";
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "{Z'M?_xrbFV::", settings1);
      Index index1 = new Index("");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      UAX29URLEmailTokenizerFactory uAX29URLEmailTokenizerFactory0 = new UAX29URLEmailTokenizerFactory(index1, indexSettingsService1, "{Z'M?_xrbFV::", settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, "aZ", settings0);
