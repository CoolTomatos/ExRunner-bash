...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "filter", settings1);
      Index index1 = new Index("aP;([WHQS[W.B, @");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      WhitespaceTokenizerFactory whitespaceTokenizerFactory0 = new WhitespaceTokenizerFactory(index1, indexSettingsService1, (String) null, settings0);
