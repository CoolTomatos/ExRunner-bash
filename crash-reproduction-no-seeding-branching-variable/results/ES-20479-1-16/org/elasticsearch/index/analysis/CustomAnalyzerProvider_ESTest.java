...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      stringArray0[0] = "$$4lMw&+QG3F^F";
      stringArray0[1] = "II4{";
      stringArray0[2] = "$$4lMw&+QG3F^F";
      stringArray0[3] = "II4{";
      stringArray0[4] = "II4{";
      stringArray0[5] = "II4{";
      stringArray0[6] = "$$4lMw&+QG3F^F";
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "$$4lMw&+QG3F^F", settings1);
      Index index1 = new Index("+3x$B;|q|Ea16");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      StandardTokenizerFactory standardTokenizerFactory0 = new StandardTokenizerFactory(index1, indexSettingsService1, "II4{", settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, "$$4lMw&+QG3F^F", settings0);
