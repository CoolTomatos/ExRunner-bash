...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("weekyear_week_day").when(index0).name();
      ...
      String string0 = "?KG@Gej#N.L@A";
      String[] stringArray0 = new String[1];
      stringArray0[0] = "weekyear_week_day";
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "?KG@Gej#N.L@A", settings1);
      Index index1 = new Index("");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      StandardTokenizerFactory standardTokenizerFactory0 = new StandardTokenizerFactory(index1, indexSettingsService1, "hlEuiq{$]#~ 8I%DI='", settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, "T-r<", settings0);
