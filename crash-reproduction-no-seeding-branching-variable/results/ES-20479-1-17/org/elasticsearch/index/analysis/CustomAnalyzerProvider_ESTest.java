...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("Aq^NX]s<").when(index0).name();
      ...
      Index index1 = new Index("qO9hmAg`ts5>v");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      NGramTokenizerFactory nGramTokenizerFactory0 = new NGramTokenizerFactory(index1, indexSettingsService1, "", settings0);
