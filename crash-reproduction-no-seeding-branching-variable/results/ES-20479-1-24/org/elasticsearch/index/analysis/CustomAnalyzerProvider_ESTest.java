...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("9KhqqZ5x*J").when(index0).name();
      ...
      stringArray0[0] = "9KhqqZ5x*J";
      stringArray0[1] = "9KhqqZ5x*J";
      ...
      Index index1 = new Index("], script_type [");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      PathHierarchyTokenizerFactory pathHierarchyTokenizerFactory0 = new PathHierarchyTokenizerFactory(index1, indexSettingsService1, " 'WIdUw", settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, " (byte 0x", settings0);
      customAnalyzerProvider0.get();
