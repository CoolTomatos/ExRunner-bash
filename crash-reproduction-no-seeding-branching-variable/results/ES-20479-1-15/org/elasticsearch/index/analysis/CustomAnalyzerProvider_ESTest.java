...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = "IRO2b\\mv%";
      String[] stringArray0 = new String[4];
      stringArray0[0] = "IRO2bmv%";
      stringArray0[1] = "]G;?ft{j|KH{'T59HL[";
      stringArray0[2] = "";
      stringArray0[3] = "Z#E";
      ...
      CustomAnalyzerProvider customAnalyzerProvider0 = new CustomAnalyzerProvider(index0, indexSettingsService0, "IRO2bmv%", settings1);
      Index index1 = new Index("IRO2bmv%");
      IndexSettingsService indexSettingsService1 = new IndexSettingsService(index1, settings0);
      ThaiTokenizerFactory thaiTokenizerFactory0 = new ThaiTokenizerFactory(index1, indexSettingsService1, "OA^W-`v0 u:;DPh", settings0);
      HtmlStripCharFilterFactory htmlStripCharFilterFactory0 = new HtmlStripCharFilterFactory(index1, indexSettingsService1, "IRO2bmv%", settings0);
