...
public class CustomAnalyzerProvider_ESTest extends CustomAnalyzerProvider_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((String) null, (String) null, "").when(index0).name();
      ...
      doReturn((String) null, "=20]]_=:\u0005U7{G").when(settings1).get(anyString());
      ...
      ClassicTokenizerFactory classicTokenizerFactory0 = new ClassicTokenizerFactory(index1, indexSettingsService1, "", settings0);
